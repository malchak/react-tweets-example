...
// Snag the inital stat that was passed from the server side
	...
	render: function () {
		...
		return (
			React.createElement("div", {className: "notification-bar" + (count > 0 ? ' active' : '')}, 
				React.createElement("p", null, "There are ", count, " new tweets!",  
					React.createElement("a", {href: "#top", onClick: this.props.onShowNewTweets}, 
...
module.exports = Tweets = React.createClass({displayName: "Tweets",
	...
	render: function () {
		...
		var content = this.props.tweets.map(function (tweet) {
			return (
				React.createElement(Tweet, {key: tweet.twid, tweet: tweet})
			)
		});
